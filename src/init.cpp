    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Lilycoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  lilycoind [options]                     " + "\n" +
                  "  lilycoind [options] <command> [params]  " + _("Send command to -server or lilycoind") + "\n" +
                  "  lilycoind [options] help                " + _("List commands") + "\n" +
                  "  lilycoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: lilycoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Lilycoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Lilycoin is probably already running."), strDataDir.c_str()));
